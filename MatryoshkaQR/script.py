...
# Step 1: Save the extracted hex data as a PNG file
...
# Save the hex data to a PNG file
with open('qrcode.png', 'wb') as file:
    file.write(hex_data)

print("Image saved as 'output_image.png'")

# Step 2: Read and decode the QR code from the saved PNG file
...
data, points, _ = qr_code_detector.detectAndDecode(image)
